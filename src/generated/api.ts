...
export class AdminAuthenticationApi extends BaseAPI {
    ...
    public verifyAuthToken(token: string, options?: AxiosRequestConfig) {
        return AdminAuthenticationApiFp(this.configuration).verifyAuthToken(token, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AdminAuthenticationApi
     */
    public verifyOAuth(provider: OAuthProvider, oAuthRequest: OAuthRequest, options?: AxiosRequestConfig) {
        return AdminAuthenticationApiFp(this.configuration).verifyOAuth(provider, oAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AdminAuthenticationApi
     */
    public verifyOAuthToken(authenticateOAuthRequest: AuthenticateOAuthRequest, options?: AxiosRequestConfig) {
        return AdminAuthenticationApiFp(this.configuration).verifyOAuthToken(authenticateOAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export class AuthenticationApi extends BaseAPI {
     ...
     */
    public verifyOAuth(provider: OAuthProvider, oAuthRequest: OAuthRequest, options?: AxiosRequestConfig) {
        return AuthenticationApiFp(this.configuration).verifyOAuth(provider, oAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public verifyOAuthToken(authenticateOAuthRequest: AuthenticateOAuthRequest, options?: AxiosRequestConfig) {
        return AuthenticationApiFp(this.configuration).verifyOAuthToken(authenticateOAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
