...
export const AuthV1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        verifyOAuthToken(requestParameters: AuthV1ApiVerifyOAuthTokenRequest, options?: AxiosRequestConfig): AxiosPromise<PlayerResponse> {
 ...
 */
export interface AuthV1ApiVerifyOAuthTokenRequest {
    /**
     * 
...
export class AuthV1Api extends BaseAPI {
     ...
     * @memberof AuthV1Api
     */
    public verifyOAuthToken(requestParameters: AuthV1ApiVerifyOAuthTokenRequest, options?: AxiosRequestConfig) {
        return AuthV1ApiFp(this.configuration).verifyOAuthToken(requestParameters.authenticateOAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
