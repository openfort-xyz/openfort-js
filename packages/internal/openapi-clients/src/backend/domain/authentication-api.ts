...
export const AuthenticationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         * @summary Authenticate player with oauth token.
         * @param {AuthenticationApiLoginWithIdTokenRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        loginWithIdToken(requestParameters: AuthenticationApiLoginWithIdTokenRequest, options?: AxiosRequestConfig): AxiosPromise<AuthResponse> {
...
/**
 * Request parameters for loginWithIdToken operation in AuthenticationApi.
 * @export
 * @interface AuthenticationApiLoginWithIdTokenRequest
 */
...
export class AuthenticationApi extends BaseAPI {
     ...
     * @memberof AuthenticationApi
     */
    public loginWithIdToken(requestParameters: AuthenticationApiLoginWithIdTokenRequest, options?: AxiosRequestConfig) {
        return AuthenticationApiFp(this.configuration).loginWithIdToken(requestParameters.loginWithIdTokenRequest, options).then((request) => request(this.axios, this.basePath));
    }
