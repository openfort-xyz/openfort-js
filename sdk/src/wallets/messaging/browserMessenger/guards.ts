...
import type { Ack1Message, Ack2Message, CallMessage, DestroyMessage, Message, ReplyMessage, SynMessage } from './types'
...
export const isDestroyMessage = (message: Message): message is DestroyMessage => message.type === 'DESTROY'
