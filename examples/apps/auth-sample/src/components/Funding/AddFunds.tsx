      ...
      <Dialog onOpenChange={handleDialogOpen}>
        ...
        {step == StepEnum.START && (
          <DialogContent>
            ...
            <button
              ...
              className={
                'w-full font-semibold border-none text-white py-4 rounded-lg'
              }
              onClick={() => {
          ...
          <DialogContent>
            ...
            <div className="flex flex-col">
              <button
                ...
                className={
                  'w-16 h-16 border-none py-4 rounded-lg bg-center bg-no-repeat bg-contain bg-right m-auto'
                }
              ></button>
              <p className="m-auto mt-4">
                Go back to {service.name} to finish funding your account.
              </p>
            </div>
          </DialogContent>
        )}
        ...
        {step == StepEnum.WAGMI_WALLET && (
          <DialogContent>
            ...
            <DialogDescription>
              Connect a wallet to deposit funds or send funds manually to your
              wallet address.
            </DialogDescription>
            <div className="flex flex-col">
              <AddFundsWithWagmi
            ...
            <div className="flex flex-col">
              {service && (
                <>
                  ...
                  ></button>
                  <p className="m-auto mt-4">
                    Account was successfully funded using {service.name}!
                  </p>
                </>
              )}
              ...
              {!service && (
                <>
                  <p className="m-auto mt-4">
                    Account was successfully funded!
                  </p>
                </>
              )}
            </div>
        ...
        {step == StepEnum.MANUAL && (
          <DialogContent>
            ...
            <DialogDescription>
              Send funds directly to your wallet by copying your wallet address.
            </DialogDescription>

            <div className="rounded p-2 bg-red-100">
              <p className="">
                Make sure to send on{' '}
            ...
            <div className="border rounded p-2">
              ...
              <div className="flex justify-between">
                ...
                {accountBalance as bigint > 0 && <p className="text-sm">
                  {formatEther(accountBalance as bigint)} ETH
                </p>}
              </div>
            </div>
          </DialogContent>
