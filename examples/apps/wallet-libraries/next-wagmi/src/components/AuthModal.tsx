    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          ...
          <button type="button" className="modal-close" onClick={onClose} disabled={isProcessing}>
            ×
          </button>
        </div>
        ...
        <div className="modal-body">
          ...
          <p className="auth-toggle-text">
            ...
            <button type="button" onClick={toggleAuthMode} className="auth-toggle-button" disabled={isProcessing}>
